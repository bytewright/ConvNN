...
if __name__ == "__main__":
    plotter_script = os.path.join(os.path.dirname(os.path.realpath(__file__)), '..', 'auto_trainer', 'my_tools', 'progress_plot.py')
    extractor_script = os.path.join(os.path.dirname(os.path.realpath(__file__)), '..', 'auto_trainer', 'my_tools', 'filter_extractor.py')
