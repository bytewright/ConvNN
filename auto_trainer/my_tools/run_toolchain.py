...
if __name__ == "__main__":
    ...
    path_list = [
        '/home/ellerch/caffeProject/auto_trainer_output/_gute_runs/alexnet_75k/job_xx_alexnet_vanilla']

    for path in path_list:
        log.info(path)
        log.info(get_test_log(path))
        log.info(get_network_path(path))
        log.info(get_weight_path(path))
